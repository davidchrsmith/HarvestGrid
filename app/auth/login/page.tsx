      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Sign in to your HarvestGrid account</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin}>
              ...
              <div className="mt-4 text-center text-sm">
                ...
                <Link href="/auth/signup" className="text-green-700 underline underline-offset-4 hover:text-green-800">
                  Create account
                </Link>
              </div>
            </form>
